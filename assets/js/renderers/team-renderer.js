    ...
    if (teamContainer && team) {
        teamContainer.innerHTML = team.map((member, index) => {
            ...
            const modalAssociationsHtml = member.associations 
                ? member.associations.map(assoc => `<li class="mb-2 text-muted small"><i class="fas fa-check text-primary me-2"></i>${assoc}</li>`).join('') 
                : '';
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 border-0 shadow-sm provider-card rounded-4 overflow-hidden bg-white d-flex flex-column">
                        <div class="position-relative overflow-hidden">
                            <img src="${member.image}" alt="${member.name}" class="pfp-1x1" onerror="this.src='assets/images/photos/team-group.avif'">
                ...
                <div class="modal fade" id="providerModal-${index}" tabindex="-1" aria-labelledby="providerModalLabel-${index}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden position-relative bg-white">
                            <!-- Floating Close Button positioned responsively via CSS -->
                            ...
                            <div class="modal-body p-4 p-md-5">
                                <div class="row g-4">
                                    <!-- Left Side: Profile Image & Affiliations -->
                                    <div class="col-md-5 text-center text-md-start pt-4 pt-md-0">
                                        ...
                                        ${modalAssociationsHtml ? `
                                            <div class="mt-4 pt-3 border-top text-start">
                                                <h6 class="text-uppercase fw-bold text-dark mb-3" style="font-size: 0.75rem; letter-spacing: 1px;">Professional Associations</h6>
                                    ...
                                    <!-- Right Side: Extensive Bio, Philosophy, Expertise -->
                                    <div class="col-md-7 border-start-md ps-md-4">
                                        <div class="mb-4">
                                            <h6 class="text-uppercase fw-bold text-muted mb-2" style="font-size: 0.7rem; letter-spacing: 1px;">Professional Bio</h6>
                                        ...
                                        ${member.philosophy ? `
                                            <div class="mb-4 p-4 bg-light rounded-4" style="border-left: 3px solid var(--primary-color) !important;">
                                                <h6 class="text-uppercase fw-bold text-primary mb-2" style="font-size: 0.7rem; letter-spacing: 1px;">Philosophy of Care</h6>
                                        ...
                                        ${modalExpertiseHtml ? `
                                            <div class="mb-4">
                                                <h6 class="text-uppercase fw-bold text-dark mb-3" style="font-size: 0.75rem; letter-spacing: 1px;">Clinical Expertise</h6>
        ...
        // Smoothly fade in the lower content and footer after team cards are loaded and rendered
        setTimeout(() => {
        ...
        // Fallback in case container/data doesn't load
        setTimeout(() => {
            const lowerContent = document.getElementById('lower-content');
            const footerRoot = document.getElementById('footer-root');
            if (lowerContent) lowerContent.style.opacity = '1';
            if (footerRoot) footerRoot.style.opacity = '1';
        }, 60);
    }
});
