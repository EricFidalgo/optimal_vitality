...
window.clinicData.services.push({
    ...
    */
      ...
      lead: "Give your body the natural signals it needs to repair joints, muscles, and gut health.",
      description: "Peptides are super-smart natural signals that tell your cells to fix damage fast. Wake up with less joint pain, recover quickly from workouts, and feel refreshed.",
      icon: "fa-vial",
      delay: "-2s",
      features: [
        "Fast joint, tendon & muscle recovery",
        "Deeper, restorative night sleep",
        "Supercharge immune & gut health",
        "Custom-dosed for your exact goals"
      ],
      image: "assets/images/photos/peptide-therapy.jpg",
      ctaText: "Claim My Healing Protocol",
